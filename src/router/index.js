...
const routes = [
  ...
  { path: '/game-ui/roadmap', name: 'game-ui-roadmap', component: () => import('../views/GameUiRoadmapView.vue'), meta: { title: 'Путеводитель', hidePublicShell: true } },
  { path: '/game-ui/trader', name: 'game-ui-trader', component: () => import('../views/GameUiTraderView.vue'), meta: { title: 'Скупщик', hidePublicShell: true } },
  ...
  { path: '/paid-terms', name: 'paid-terms', component: () => import('../views/PaidTermsView.vue'), meta: { title: 'Условия платных услуг' } },
  ...
  { path: '/killfeed', name: 'killfeed', component: () => import('../views/KillfeedView.vue'), meta: { title: 'Лента убийств', feature: 'killfeed' } },
  ...
  { path: '/internal-admin/market', name: 'admin-market', component: () => import('../views/AdminMarketView.vue'), meta: { title: 'Market Admin', hidePublicShell: true } },
  {
    ...
    children: [
      ...
      { path: 'trader', name: 'admin-trader', component: () => import('../views/admin/AdminTraderView.vue'), meta: { title: 'Скупщик', requiresAuth: true, requiresAdmin: true, hidePublicShell: true, permission: 'trader.view', serverScoped: true } },
      { path: 'upgrader', name: 'admin-upgrader', component: () => import('../views/admin/AdminUpgraderView.vue'), meta: { title: 'Апгрейдер', requiresAuth: true, requiresAdmin: true, hidePublicShell: true, permission: 'upgrader.view', serverScoped: true } },
      ...
      { path: 'auth', name: 'admin-auth', component: () => import('../views/admin/AdminAuthSettingsView.vue'), meta: { title: 'Авторизация', requiresAuth: true, requiresAdmin: true, hidePublicShell: true, permission: 'servers.manage', serverScoped: true } },
      ...
      { path: 'voxel', name: 'admin-voxel', component: () => import('../views/admin/AdminVoxelView.vue'), meta: { title: 'Voxel Engine', requiresAuth: true, requiresAdmin: true, hidePublicShell: true, permission: 'voxel.view', serverScoped: true } },
