...
import { hasServerGuide } from '../data/serverGuides.js'
...
const navItems = computed(() => [
  ...
  },
  {
    ...
    // Guide always resolves to the per-server /server-guide (reactive to the active
    // server). The Mods list is only meaningful for the main (default) server.
    children: [
      hasServerGuide(activeServer.value?.slug)
        ? { label: t('nav.serverGuide'), to: '/server-guide', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>', desc: t('nav.serverGuideDesc') }
        : { label: t('nav.guideModpack'), to: '/server-guide', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>', desc: t('nav.guideModpackDesc') },
      ...(activeServer.value?.is_default
        ? [{ label: t('nav.mods'), to: '/mods', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/></svg>', desc: t('nav.modsDesc') }]
        : []),
    ],
  },
  {
    ...
    children: [
      { label: t('nav.market'), to: '/market', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>', desc: t('nav.marketDesc'), feature: 'economy' },
      { label: t('nav.shop'), to: '/shop', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>', desc: t('nav.shopDesc'), feature: 'shop' },
    ],
  },
  {
    ...
    children: [
      { label: t('nav.nations'), to: '/nations', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>', desc: t('nav.nationsDesc'), feature: 'nations' },
  ...
  },
  {
    ...
    children: [
      { label: t('nav.topPlayers'), to: '/players/top', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>', desc: t('nav.topPlayersDesc'), feature: 'leaderboards' },
      { label: t('nav.ageProgress'), to: '/leaderboard', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg>', desc: t('nav.ageProgressDesc'), feature: 'progression' },
      { label: t('nav.nationsRanking'), to: '/nations/rankings', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>', desc: t('nav.nationsRankingDesc'), feature: 'nations' },
      { label: t('nav.bounties'), to: '/bounties', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>', desc: t('nav.bountiesDesc'), feature: 'bounties' },
      { label: t('nav.killfeed'), to: '/killfeed', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 17.5 3 6V3h3l11.5 11.5"/><path d="M13 19l6-6"/><path d="M16 16l4 4"/><path d="M19 21l2-2"/></svg>', desc: t('nav.killfeedDesc'), feature: 'killfeed' },
    ],
  },
].map((item) => {
  if (!item.children) return item.feature && !feat(item.feature) ? null : item
  const children = item.children.filter((c) => !c.feature || feat(c.feature))
  return children.length ? { ...item, children } : null
}).filter(Boolean))

const externalItems = computed(() => [
  // Per-server map: use the server's own map URL, hide if the feature is off.
  ...(feat('map') ? [{ label: t('nav.map'), href: activeServer.value?.map_url || siteConfig.bluemapUrl }] : []),
