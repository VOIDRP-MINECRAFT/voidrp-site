...
const quickLinks = computed(() => _quickLinks.filter((l) => hasPermission(l.perm)))
</script>
  ...
  <div class="adm-page">
    ...
    <div>
      ...
      <div v-else-if="stats" class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        ...
        <RouterLink v-if="canBattlepass && stats.battlepass" to="/admin/battlepass" class="mini-kpi">
        ...
        <RouterLink v-if="canMarket && stats.market" to="/admin/market" class="mini-kpi">
