...
const PAGES = (process.argv[3] || 'menu,treasury,research,quests,alliance,battlepass,nmarket,market').split(',')
const OUT = '/tmp/claude-1001/-home-mironoouv-minecraft/ce93cdbb-4ef0-4939-9019-734cc7ea26db/scratchpad'
